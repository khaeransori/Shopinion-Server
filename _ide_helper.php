 ...
 * Generated for Laravel 4.2.17 on 2015-02-16.
 *
...
namespace {
    ...
    class Route extends \Illuminate\Support\Facades\Route{
         ...
         * @static 
         */
        public static function dispatch($request, $morph = true){
            return \Dingo\Api\Routing\Router::dispatch($request, $morph);
        }
    ...
    class REST extends \Shopinion\Services\Responses\RestResponse{
