 ...
 * Generated for Laravel 4.2.17 on 2015-05-02.
 *
...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         *
         * @return \App\Core\Entities\User\User|null 
         * @static 
         */
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \App\Core\Entities\User\User 
         * @static 
         */
    ...
    class Route extends \Illuminate\Support\Facades\Route{
         ...
         * @static 
         */
        public static function dispatch($request, $raw = false){
            return \Dingo\Api\Routing\Router::dispatch($request, $raw);
        }
    ...
    class Entrust extends \Zizaco\Entrust\EntrustFacade{
         ...
         *
         * @access public
         * @return \Zizaco\Entrust\App\Core\Entities\User\User|null 
         * @static 
         */
        public static function user(){
